...
Route::get('departments/{id}', 'API\CentreController@getDepartmentById');
Route::get('departments/supervisor/{supervisorId}', 'API\CentreController@getDepartmentsBySupervisorId');
