                        ...
                        <div class="card card-info text-white mb-4 ml-4 p-0 mt-0">
                            ...
                            <div class="card-body">
                                <h5 class="card-title font-size-18">1.- Importar venta privada, plantilla puede
                                                    descargarse <a style="color:var(--red-icot)"
                                                        href="{{ asset('assets/excel/plantilla_importar_objetivos_centros.xls') }}">aquí</a>
                                </h5>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="importTargetForm" method="POST">
                                ...
                                @if ($user->rol_id == 1)
                                    <div class="row ml-2 px-5">
                                        ...
                                        <div class="form-group"
                                            style="flex:0 0 17% !important; padding-left:0px; padding-top: 6px;">
                                            <div id="btnImportTargets"
                                                ...
                                                <input type="text" id="fileuploadurl" readonly
                                                    placeholder="Tamaño máximo de fichero son 2MB">
                                            </div>
                                            <button id="targetInputFileLoad" type="submit"
                                                class="file-upload btn btn-success" style="display: none">
                                ...
                                @endif -->
                                <div class="row  mt-2 px-5 justify-between">
                                    <div class="form-group col-md-4"
                                        style="flex:0 0 17% !important; padding-left:0px; padding-top: 6px;">
                                        <div id="btnImportSales"
                                            class="file-upload mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"
                                            style="margin-left: 16px">
                                    ...
                                    <div class="form-group col-md-2 input-group date" style="padding-top: 15px;">
                                ...
                                <div class="row mt-2 px-5">
                                    <div class="col-md-5">
                                        <button id="btnSubmit" type="submit"
                                            class="btn btn-fill btn-dark-black">{{ __('Exportar') }}</button>
