        ...
        <div class="container-fluid" style="">
            <div class="col-lg-12">
                            ...
                            <div class="informes-container">
                                <div class="date-informes-container">
                                    <form id="serviceForm" action="{{ route('calculateServices') }}" method="GET">
                                        ...
                                        <label class="col-form-label-lg" for="dateFrom">Fecha
                                            desde
                                        </label>
                                        ...
                                        <label class="col-form-label-lg" for="dateTo" style="margin-top: 30px;">Fecha
                                            hasta
                                        </label>
                                        <div id="monthYearPickerContainer" style="margin-bottom:15px;">
                                    ...
                                    <div id="picker-container" class="picker-container">
                                        ...
                                        <form action="{{ route('calculateServices') }}" method="GET">
                                            <div class="select-wrapper">
                                                ...
                                                <input type="hidden" name="service_id" value="{{ $service_id }}">
                                                <select class="selectpicker" data-style="btn btn-red-icot btn-round"
                                                    id="centre_id" name="centre_id" onchange="this.form.submit()">
                                        ...
                                        <label for="centre" class="col-form-label-lg">Servicios</label>
                                        ...
                                        <form id="centreForm" action="{{ route('calculateServices') }}" method="GET">
                                            <div class="select-wrapper">
                                                ...
                                                <input type="hidden" name="centre_id" value="{{ $centre_id }}">
                                                <select class="selectpicker" data-style="btn btn-red-icot btn-round"
                                                    id="service_id" name="service_id" onchange="this.form.submit()">
                                                    <option value="">TODOS</option>
                                ...
                                <div id="btn-container-box" class="btn-container-box">
                                    ...
                                    <form action="{{ route('export.all-services') }}" method="GET">
                                        ...
                                        <button id="btnSubmit" type="submit" class="btn-export">EXPORTAR <span
                                                id="icon-export"
                        ...
                        <thead>
                            @if (request('start_date') && request('end_date'))
                                <tr class="row-service" style="background-color: var(--red-icot);color:white;">
                                    <th colspan="5">Fecha : {{ request('start_date') }} /
                                        {{ request('end_date') }}
                                    </th>
                                </tr>
                            @endif
                ...
                @if (!empty($service_id) && !empty($centre_id))
                    ...
                    <div class="card mt-4">
                        <div class="chart-container">
                            <h4>Ventas de <strong>TODOS</strong> los Servicios en
                                <strong>{{ $selectedCentre->name }}</strong>
                                por <strong>EMPLEADO</strong>
                            </h4>
                            <div>
                                <canvas id="chartTotalEmployee"></canvas>
                            </div>
                ...
                @if (!empty($service_id) && empty($centre_id))
                    <div class="card mt-4">
                        <div class="chart-container">
                            <h4>Ventas de <strong>{{ $selectedService->name }}</strong> en <strong>TODOS LOS
                                    CENTROS</strong>
                            </h4>
                            <div>
                    ...
                    <div class="card mt-4">
                        <div class="chart-container">
                            <h4>Ventas de <strong>{{ $selectedService->name }}</strong> por <strong>CENTROS</strong>
                            </h4>
                            <div>
