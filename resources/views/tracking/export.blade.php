                            ...
                            <form id="exportTracking" action="{{ route('tracking.export') }}" method="POST">
                                ...
                                <div class="row px-5">
                                    <div class="col-md-2">
                                        ...
                                        <input type="date" id="date_from" name="date_from" max="3000-12-31" min="1000-01-01"
                                        ...
                                        <div class="form-group checkbox-radios">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="trackingState"
                                                        value="service" checked=""> Realizados
                                                    <span class="circle">
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="dropdown bootstrap-select">
                                                    <select class="selectpicker" name="service_id" id="service_id"
                                                        data-size="7" data-style="btn btn-primary btn-round"
                                                        title=" Seleccione Servicio" tabindex="-98">
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="dropdown bootstrap-select">
                                                    <select class="selectpicker" name="patient_name" id="patient_name"
                                                        data-size="7" data-style="btn btn-primary btn-round"
                                                        title=" Seleccione Paciente" tabindex="-98">
                                ...
                                <div class="row mt-2 px-5">
                                    <div class="col-md-5">
                                        ...
                                        <button id="btnSubmit" type="submit"
                                            class="btn btn-fill btn-blue">{{ __('Imprimir') }}</button>
