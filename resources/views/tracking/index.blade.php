...
<script type="text/javascript">
    ...
    columnsFilled.push({data: 'employee', name: 'employee', searchable: true });
    columnsFilled.push({data: 'hc', name: 'hc'});
    columnsFilled.push({data: 'patient_name', name: 'patient_name', searchable: true });
    columnsFilled.push({data: 'service', name: 'service', searchable: true});
    columnsFilled.push({data: 'state', name: 'state', searchable: true});
    columnsFilled.push({name: 'state_date',  data: 'state_date'});
    ...
    function getTrackingData() {
        ...
        if ( $.fn.dataTable.isDataTable( '.tracking-datatable') ) {
            ...
            table = $('.tracking-datatable').DataTable({
                ...
                columnDefs:[
                    { targets: 6, data: "state_date", type:"date",
