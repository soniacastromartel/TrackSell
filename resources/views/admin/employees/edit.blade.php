                            ...
                            <form id=editEmployee action="{{ route('editProfile', $employee->id) }}" method="POST">
                                ...
                                <div class="row" style="justify-content: space-around;">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <label class="label">Centro de trabajo <span class="obligatory">*</span></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row col-lg-12 mt-3">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="date" id="date_before" name="date_before" max="3000-12-31" min="1000-01-01" value="{{$dayYesterday}}" class="form-control" />
                                                </div>
                                                <div class="col-lg-6">
                                                    <label class="label" for="name">Fecha nueva </label>
                                                    <input type="date" id="date_new" name="date_new" max="3000-12-31" min="1000-01-01" value="{{$dayNow}}" class="form-control" />
                                                </div>
                                            </div>
