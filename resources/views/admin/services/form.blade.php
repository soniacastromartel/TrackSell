  ...
  <div class="justify-content-start">
    <div id="containerImg" class="text-center">
        <label id="lbl" for="image">Imagen de Servicio <span id="obligatory">*</span></label>
        <br><br>
        <div>
          ...
          <br>
          <input type="file" class="btn btn-danger btn-sm mt-1" name="changeImg" id="changeImg" style="width:100%;"/>
          <br><br>
          <div class="row">
            <div class="col-6">
  ...
  <div class="row col-7 mr-3 justify-content">
      ...
      <div class="col-6">
        <br>
          <label id="lbl" for="category">Categoría <span id="obligatory">*</span></label>
          <select class="selectpicker text-center" name="category" id="category" class="text-center" data-size="6" data-style="btn btn-danger btn-round" title="* Seleccione Categoría de servicio" tabindex="-98">
          @if(isset($categories))
      ...
      <div class="col-12">
        <label id="lbl" for="url">URL <span id="obligatory">*</span></label>
        <input type="text" class="form-control" name="url" id="url"  placeholder="" value="{{ isset($service) ? $service->url : ''}}">
    </div>
    <div class="col-12">
      <label id="lbl" for="description">Descripción <span id="obligatory">*</span></label>
