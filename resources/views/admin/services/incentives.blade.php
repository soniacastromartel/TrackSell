            ...
            function exportServicesToExcel() {
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        $('#alertErrorServiceIncentive').text(
                            'Ha ocurrido un error al exportar los servicios, contacte con el administrador');
                        ...
                        columnDefs: [{
                            ...
                            },
                            {
                                ...
                                render: $.fn.dataTable.render.number('.', ',',
                                    2) //columnDefs number renderer (thousands, decimal, precision, simbolo/moneda)
                            },
