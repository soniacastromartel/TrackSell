...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row col-md-12 mb-3">
            <div class="col-md-3 mt-2">
                ...
                <form id="importTargetForm"  method="POST" >
                    ...
                    <div class="form-group" style="margin-top:6px">
                        <div id="btnImportIncentives"  style ="background-color:blue !important;" class="file-upload mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
            ...
            <div id="btnExportIncentives"  class="mt-3 file-upload mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
                <span>{{ __('Exportar Servicios Incentivados') }}</span>
            </div>
            <button id="targetExportFileLoad" type="submit" class="file-upload btn btn-success" style="display: none">
                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                {{ __('Exportando datos...') }}
            </button>
        </div>
...
<script type="text/javascript">
    ...
    columnsFilled.push({data: 'price', name: 'price'});
    columnsFilled.push({data: 'incentive_direct', name: 'incentive_direct'});
    columnsFilled.push({data: 'incentive_obj1', name: 'incentive_obj1'});
    columnsFilled.push({data: 'incentive_obj2', name: 'incentive_obj2'});
    columnsFilled.push({data: 'bonus_obj1', name: 'bonus_obj1'});
    columnsFilled.push({data: 'bonus_obj2', name: 'bonus_obj2'});
    columnsFilled.push({data: 'cancellation_date', name: 'cancellation_date'});
    columnsFilled.push({data: 'action', name: 'action'});    
