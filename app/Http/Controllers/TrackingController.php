...
class TrackingController extends Controller
{
    ...
    public function index(Request $request){
        ...
        try{
            ...
            return view('tracking.index', ['title' => $title, 'mensaje' => '' 
                                            ,  'centres'  => $centres 
                                            ,  'states'   => $states 
    ...
    public function create()
    {
        ...
        try {
            ...
            return view('tracking.create', ['title'            => $title
                                            ,'centres'         => $centres
                                            ,'services'        => $services
                                            ,'employees'       => $employees
    ...
    public function edit($state, $id)
    {
        ...
        try {
            ...
            return view('tracking.edit', ['title'           => 'Modificar recomendación'
                                        , 'tracking'        => $tracking
                                        , 'centres'         => $centres
                                        , 'services'        => $services
                                        , 'employees'       => $employees
                ...
                if (!empty($tId)) {
                    ...
                    if ($validateFechas['result'] === false) {
                        ...
                        return response()->json(['success' => false
                                            ...
                                            , 'mensaje'=> $validateFechas['message']], 400);
                    }
    ...
    public function deleteForm() {
        try {
            ...
            return view('tracking.delete', ['title'    => 'Borrar Seguimiento'
                                            , 'centres'  => $centres
                                            , 'services' => $services
                                            , 'employees' => $employees
                                        ]);
    ...
    public function exportForm() {
        try {
            ...
            return view('tracking.export', ['title'      => 'Exportar recomendaciones'
                                        , 'centres'   => $centres
                                        , 'services'  => $services
                                        , 'patients'  => $patients
                                        , 'employees' => $employees
        ...
        try {
            ...
            if ($validateFechas['result'] === false) {
                return response()->json(['success' => false
                                    ...
                                    , 'mensaje'=> 'La fecha de cancelación no puede ser fuera del corte actual'], 400);
            }

            $tracking->update($fields);
            return response()->json(['success' => true
                                    , 'url'    => '/tracking/deleteForm' 
                                    , 'mensaje'=> 'Recomendacion eliminada correctamente'], 200);
    ...
    public function searchDelete(Request $request)
    {
        try {
            ...
            $tracking = DB::table('trackings')
                                ...
                                ->join('services','services.id','=','service_id')
                                ->join('employees','employees.id','=','employee_id')
                                ->whereNull('trackings.cancellation_date')->get(); 
    ...
    function checkServiceCentre($params, $state){
        $error = false; 
        $serviceAvailable = ServicePrice::where(['service_id' => $params['service_id']
                ,'centre_id'  => $params['centre_id']])->get(); 
    ...
    public function getFinalValidationData($request)
    {
        ...
        foreach($detailedSales as $eId => $detailedSale) {
            ...
            if (isset($params['monthYear']) && !empty($params['monthYear'])) {
                ...
                ->where(['employee_id' => $detailedSale['employee_id']
    ...
    public function indexFinalValidation(Request $request)
    {
        try {
            ...
            return view('tracking.indexvalidation', ['title'            => 'Validar RRHH'
                                                     , 'mensaje'        => '' 
                                                     , 'centres'        => $centres
    ...
    public function requestChange(Request $request) {
        ...
        return view('tracking.request_change_centre', ['title'     => 'Nueva solicitud',
                                                       'centres'   => $centres,
                                                       'employees' => $employees
        ]);
    }
    ...
    public function confirmRequest(Request $request) {
        try{
            ...
            $requestChange->update(['validated'         => $params['state'],
