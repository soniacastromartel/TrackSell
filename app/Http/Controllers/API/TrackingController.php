...
class TrackingController extends BaseController
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            if (!Tracking::checkDate($params['tracking_date'])) {
                return $this->sendError('Fecha fuera de periodo de corte, corrijalo por favor');
            }

            $employee = Employee::findByField('username', $params['employee']);
            if (!$employee) {
            ...
            if (isset($fieldMap[$params['idType']])) {
                $params[$fieldMap[$params['idType']]] = $params['patientId'];
            }
